...
public class Block
{
    ...
    public virtual void RegisterBlocks()
    {
        // utilisé par les blocs moddés pour directement se registrer
    }

    public static readonly Block Stone = new BlockStone(1, "stone").setHardness(1.5F).setResistance(10.0F).setSoundGroup(SoundStoneFootstep).setBlockName("stone");
    ...
    public static readonly Block Dirt = new BlockDirt(3, "dirt").setHardness(0.5F).setSoundGroup(SoundGravelFootstep).setBlockName("dirt");
    public static readonly Block Cobblestone = new Block(4, "cobblestone", Material.Stone).setHardness(2.0F).setResistance(10.0F).setSoundGroup(SoundStoneFootstep).setBlockName("stonebrick");
    public static readonly Block Planks = new Block(5, "planks_oak", Material.Wood).setHardness(2.0F).setResistance(5.0F).setSoundGroup(SoundWoodFootstep).setBlockName("wood").ignoreMetaUpdates();
    public static readonly Block Sapling = new BlockSapling(6, "sapling_oak").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("sapling").ignoreMetaUpdates();
    public static readonly Block Bedrock = new Block(7, "bedrock", Material.Stone).setUnbreakable().setResistance(6000000.0F).setSoundGroup(SoundStoneFootstep).setBlockName("bedrock").disableStats();
    ...
    public static readonly Block Sand = new BlockSand(12, "sand").setHardness(0.5F).setSoundGroup(SoundSandFootstep).setBlockName("sand");
    public static readonly Block Gravel = new BlockGravel(13, "gravel").setHardness(0.6F).setSoundGroup(SoundGravelFootstep).setBlockName("gravel");
    public static readonly Block GoldOre = new BlockOre(14, "gold_ore").setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreGold");
    public static readonly Block IronOre = new BlockOre(15, "iron_ore").setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreIron");
    public static readonly Block CoalOre = new BlockOre(16, "coal_ore").setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreCoal");
    ...
    public static readonly BlockLeaves Leaves = (BlockLeaves)new BlockLeaves(18, "leaves_oak").setHardness(0.2F).setOpacity(1).setSoundGroup(SoundGrassFootstep).setBlockName("leaves").disableStats().ignoreMetaUpdates();
    ...
    public static readonly Block Glass = new BlockGlass(20, "glass", Material.Glass, false).setHardness(0.3F).setSoundGroup(SoundGlassFootstep).setBlockName("glass");
    public static readonly Block LapisOre = new BlockOre(21, "lapis_ore").setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreLapis");
    public static readonly Block LapisBlock = new Block(22, "lapis_block", Material.Stone).setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("blockLapis");
    ...
    public static readonly Block PoweredRail = new BlockRail(27, "rail_golden", true).setHardness(0.7F).setSoundGroup(SoundMetalFootstep).setBlockName("goldenRail").ignoreMetaUpdates();
    public static readonly Block DetectorRail = new BlockDetectorRail(28, "rail_detector").setHardness(0.7F).setSoundGroup(SoundMetalFootstep).setBlockName("detectorRail").ignoreMetaUpdates();
    public static readonly Block StickyPiston = new BlockPistonBase(29, "piston_top_sticky", true).setBlockName("pistonStickyBase").ignoreMetaUpdates();
    public static readonly Block Cobweb = new BlockWeb(30, "web").setOpacity(1).setHardness(4.0F).setBlockName("web");
    public static readonly BlockTallGrass Grass = (BlockTallGrass)new BlockTallGrass(31, "grass").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("tallgrass");
    public static readonly BlockDeadBush DeadBush = (BlockDeadBush)new BlockDeadBush(32, "deadbush").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("deadbush");
    public static readonly Block Piston = new BlockPistonBase(33, "piston_top", false).setBlockName("pistonBase").ignoreMetaUpdates();
    public static readonly BlockPistonExtension PistonHead = (BlockPistonExtension)new BlockPistonExtension(34, "piston_top").ignoreMetaUpdates();
    ...
    public static readonly BlockPlant Dandelion = (BlockPlant)new BlockPlant(37, "flower_dandelion").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("flower");
    public static readonly BlockPlant Rose = (BlockPlant)new BlockPlant(38, "flower_rose").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("rose");
    public static readonly BlockPlant BrownMushroom = (BlockPlant)new BlockMushroom(39, "mushroom_brown_top").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setLuminance(2.0F / 16.0F).setBlockName("mushroom");
    public static readonly BlockPlant RedMushroom = (BlockPlant)new BlockMushroom(40, "mushroom_red_top").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("mushroom");
    public static readonly Block GoldBlock = new BlockOreStorage(41, "gold_block").setHardness(3.0F).setResistance(10.0F).setSoundGroup(SoundMetalFootstep).setBlockName("blockGold");
    public static readonly Block IronBlock = new BlockOreStorage(42, "iron_block").setHardness(5.0F).setResistance(10.0F).setSoundGroup(SoundMetalFootstep).setBlockName("blockIron");
    ...
    public static readonly Block Bricks = new Block(45, "brick", Material.Stone).setHardness(2.0F).setResistance(10.0F).setSoundGroup(SoundStoneFootstep).setBlockName("brick");
    public static readonly Block TNT = new BlockTNT(46, "tnt").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("tnt");
    public static readonly Block Bookshelf = new BlockBookshelf(47, "bookshelf").setHardness(1.5F).setSoundGroup(SoundWoodFootstep).setBlockName("bookshelf");
    public static readonly Block MossyCobblestone = new Block(48, "cobblestone_mossy", Material.Stone).setHardness(2.0F).setResistance(10.0F).setSoundGroup(SoundStoneFootstep).setBlockName("stoneMoss");
    public static readonly Block Obsidian = new BlockObsidian(49, "obsidian").setHardness(10.0F).setResistance(2000.0F).setSoundGroup(SoundStoneFootstep).setBlockName("obsidian");
    public static readonly Block Torch = new BlockTorch(50, "torch_on").setHardness(0.0F).setLuminance(15.0F / 16.0F).setSoundGroup(SoundWoodFootstep).setBlockName("torch").ignoreMetaUpdates();
    public static readonly Block Fire = (BlockFire)new BlockFire(51, "fire_0").setHardness(0.0F).setLuminance(1.0F).setSoundGroup(SoundWoodFootstep).setBlockName("fire").disableStats().ignoreMetaUpdates();
    public static readonly Block Spawner = new BlockMobSpawner(52, "mob_spawner").setHardness(5.0F).setSoundGroup(SoundMetalFootstep).setBlockName("mobSpawner").disableStats();
    ...
    public static readonly Block RedstoneWire = new BlockRedstoneWire(55, "redstone_dust_cross").setHardness(0.0F).setSoundGroup(SoundPowderFootstep).setBlockName("redstoneDust").disableStats().ignoreMetaUpdates();
    public static readonly Block DiamondOre = new BlockOre(56, "diamond_ore").setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreDiamond");
    public static readonly Block DiamondBlock = new BlockOreStorage(57, "diamond_block").setHardness(5.0F).setResistance(10.0F).setSoundGroup(SoundMetalFootstep).setBlockName("blockDiamond");
    ...
    public static readonly Block Wheat = new BlockCrops(59, "wheat_stage_7").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("crops").disableStats().ignoreMetaUpdates();
    ...
    public static readonly Block Ladder = new BlockLadder(65, "ladder").setHardness(0.4F).setSoundGroup(SoundWoodFootstep).setBlockName("ladder").ignoreMetaUpdates();
    public static readonly Block Rail = new BlockRail(66, "rail_normal", false).setHardness(0.7F).setSoundGroup(SoundMetalFootstep).setBlockName("rail").ignoreMetaUpdates();
    ...
    public static readonly Block Lever = new BlockLever(69, "lever").setHardness(0.5F).setSoundGroup(SoundWoodFootstep).setBlockName("lever").ignoreMetaUpdates();
    ...
    public static readonly Block RedstoneOre = new BlockRedstoneOre(73, "redstone_ore", false).setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreRedstone").ignoreMetaUpdates();
    public static readonly Block LitRedstoneOre = new BlockRedstoneOre(74, "redstone_ore", true).setLuminance(10.0F / 16.0F).setHardness(3.0F).setResistance(5.0F).setSoundGroup(SoundStoneFootstep).setBlockName("oreRedstone").ignoreMetaUpdates();
    public static readonly Block RedstoneTorch = new BlockRedstoneTorch(75, "redstone_torch_off", false).setHardness(0.0F).setSoundGroup(SoundWoodFootstep).setBlockName("notGate").ignoreMetaUpdates();
    public static readonly Block LitRedstoneTorch = new BlockRedstoneTorch(76, "redstone_torch_on", true).setHardness(0.0F).setLuminance(0.5F).setSoundGroup(SoundWoodFootstep).setBlockName("notGate").ignoreMetaUpdates();
    ...
    public static readonly Block Snow = new BlockSnow(78, "snow").setHardness(0.1F).setSoundGroup(SoundClothFootstep).setBlockName("snow");
    public static readonly Block Ice = new BlockIce(79, "ice").setHardness(0.5F).setOpacity(3).setSoundGroup(SoundGlassFootstep).setBlockName("ice");
    public static readonly Block SnowBlock = new BlockSnowBlock(80, "snow").setHardness(0.2F).setSoundGroup(SoundClothFootstep).setBlockName("snow"); 
    public static readonly Block Cactus = new BlockCactus(81, "cactus").setHardness(0.4F).setSoundGroup(SoundClothFootstep).setBlockName("cactus");
    public static readonly Block Clay = new BlockClay(82, "clay").setHardness(0.6F).setSoundGroup(SoundGravelFootstep).setBlockName("clay");
    public static readonly Block SugarCane = new BlockReed(83, "reeds").setHardness(0.0F).setSoundGroup(SoundGrassFootstep).setBlockName("reeds").disableStats();
    public static readonly Block Jukebox = new BlockJukeBox(84, "jukebox_side").setHardness(2.0F).setResistance(10.0F).setSoundGroup(SoundStoneFootstep).setBlockName("jukebox").ignoreMetaUpdates();
    public static readonly Block Fence = new BlockFence(85, "planks_oak").setHardness(2.0F).setResistance(5.0F).setSoundGroup(SoundWoodFootstep).setBlockName("fence").ignoreMetaUpdates();
    public static readonly Block Pumpkin = new BlockPumpkin(86, "pumpkin_top", false).setHardness(1.0F).setSoundGroup(SoundWoodFootstep).setBlockName("pumpkin").ignoreMetaUpdates();
    public static readonly Block Netherrack = new BlockNetherrack(87, "netherrack").setHardness(0.4F).setSoundGroup(SoundStoneFootstep).setBlockName("hellrock");
    public static readonly Block Soulsand = new BlockSoulSand(88, "soul_sand").setHardness(0.5F).setSoundGroup(SoundSandFootstep).setBlockName("hellsand");
    public static readonly Block Glowstone = new BlockGlowstone(89, "glowstone", Material.Stone).setHardness(0.3F).setSoundGroup(SoundGlassFootstep).setLuminance(1.0F).setBlockName("lightgem");
    public static readonly BlockPortal NetherPortal = (BlockPortal)new BlockPortal(90, "portal").setHardness(-1.0F).setSoundGroup(SoundGlassFootstep).setLuminance(12.0F / 16.0F).setBlockName("portal");
    public static readonly Block JackLantern = new BlockPumpkin(91, "pumpkin_top", true).setHardness(1.0F).setSoundGroup(SoundWoodFootstep).setLuminance(1.0F).setBlockName("litpumpkin").ignoreMetaUpdates();
    public static readonly Block Cake = new BlockCake(92, "cake_top").setHardness(0.5F).setSoundGroup(SoundClothFootstep).setBlockName("cake").disableStats().ignoreMetaUpdates();
    ...
    protected Block(int id, string textureId, Material material) : this(id, material)
    {
    ...
    // pointeurs d'accesiblité

    public void SetTickRandom(bool value) => setTickRandomly(value);
    public Block SetHardness(float value) => setHardness(value);
    public Block SetResistance(float value) => setResistance(value);
    public Block SetLuminance(float value) => setLuminance(value);
    public virtual bool isSolidFace(BlockView blockView, int x, int y, int z, int face)
    {
        return blockView.getMaterial(x, y, z).IsSolid;
    }

    public virtual string getTextureId(BlockView blockView, int x, int y, int z, string side)
    {
        return getTexture(side, blockView.getBlockMeta(x, y, z));
    }

    public virtual string getTexture(string side, int meta)
    {
        return getTexture(side);
    }

    public virtual string getTexture(string side)
    {
        return textureId;
    }
    ...
    public static string faceInt2String(int orig)
    {
        return (orig) switch
        {
            0 => "bottom",
    ...
    public static int faceString2Int(string orig)
    {
        return (orig) switch
        {
            "bottom" => 0,
